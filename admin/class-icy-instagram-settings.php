...
//		$wcsi->deleteCache();
	...
	function configuration_callback() {
		...
		$display_tags = isset( $settings_value['tags'] ) ? $settings_value['tags'] : '';
		$author = isset( $settings_value['author'] ) ? $settings_value['author'] : '';
		...
		// Tags
		echo '<p><input type="text" name="icy_instagram_config_settings[tags]" value="' . $display_tags . '"   />';
		echo '<span class="description" style="margin: 0 0 0 10px;">' . __( 'Tag, without - #' ) . '</span></p>';

		//Author for verify
		echo '<p><input type="text" name="icy_instagram_config_settings[author]" value="' . $author . '"   />';
		echo '<span class="description" style="margin: 0 0 0 10px;">' . __( 'Author, for verify' ) . '</span></p>';

		// Number of images to display
		echo '<p><input type="number" name="icy_instagram_config_settings[display_num]" value="' . $display_num . '" min="1"  />';
		echo '<span class="description" style="margin: 0 0 0 10px;">' . __( 'How many Instagram images would you like to display? ' ) . '</span></p>';
